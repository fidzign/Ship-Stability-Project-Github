...
public class RainGlobalControlPro : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        {
			Mathf.Lerp(rain_Particles[i].GetComponent<Renderer>().material.color.a, rainLevel * 0.2f, Time.deltaTime * transitionSpeed);
            i++;
        }
        ...
        {
            float a_float = rain_Pro[j].GetComponent<Renderer>().material.GetFloat("_BumpAmt");
            rain_Pro[j].GetComponent<Renderer>().material.SetFloat("_BumpAmt", Mathf.Lerp(a_float, rainLevel * 60, Time.deltaTime * transitionSpeed));
            j++;
        }
        ...
        {
            Mathf.Lerp(rain_Ripples[k].GetComponent<Renderer>().material.color.a, rainLevel * 0.3f, Time.deltaTime * transitionSpeed);
            k++;
        }
        ...
        {
            rain_Sound [l].GetComponent<AudioSource>().volume = Mathf.Lerp(rain_Sound[l].GetComponent<AudioSource>().volume, rainLevel, Time.deltaTime * transitionSpeed);
            l++;
        }
        ...
        {
            effect_Pro.GetComponent<Renderer>().enabled = false;
        }
        else
        {
            effect_Pro.GetComponent<Renderer>().enabled = true;
        }
