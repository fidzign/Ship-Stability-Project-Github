...
public class RainGlobalControlIndie : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        {
            float @float = rain_Pro[j].GetComponent<Renderer>().material.GetFloat("_BumpAmt");
            rain_Pro[j].GetComponent<Renderer>().material.SetFloat("_BumpAmt", Mathf.Lerp(@float, rainLevel * 60, Time.deltaTime * transitionSpeed));
            j++;
        }
